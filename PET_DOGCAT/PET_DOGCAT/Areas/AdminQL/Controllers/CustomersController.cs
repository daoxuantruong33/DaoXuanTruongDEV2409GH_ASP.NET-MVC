...
namespace PET_DOGCAT.Areas.AdminQL.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public CustomersController(PetsDogcatContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FirstName,LastName,Password,Email,Address,CreatedAt")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FirstName,LastName,Password,Email,Address,CreatedAt")] Customer customer)
        {
