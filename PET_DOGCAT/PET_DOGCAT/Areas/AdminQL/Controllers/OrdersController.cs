...
namespace PET_DOGCAT.Areas.AdminQL.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(PetsDogcatContext context)
        {
            _context = context;
        }
        ...
        {
            var petsDogcatContext = _context.Orders.Include(o => o.Customer);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,TotalAmount,OrderDate,Status")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,TotalAmount,OrderDate,Status")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
