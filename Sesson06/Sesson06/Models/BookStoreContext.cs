...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-RUUP3FM6\\SQLEXPRESS;Database=BookStore;Integrated Security=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A697A913A4");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2077BF9B9B2");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B8932E785");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCFCA208550");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.OrderBooks)
                ...
                .HasConstraintName("FK__OrderBook__Accou__403A8C7D");
        });

        modelBuilder.Entity<OrderDetail>(entity =>
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C3F0D974E");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB202B223E");
