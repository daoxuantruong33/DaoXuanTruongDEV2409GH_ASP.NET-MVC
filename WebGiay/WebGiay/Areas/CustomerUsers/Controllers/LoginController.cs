...
using WebGiay.Areas.CustomerUsers.Models;
...
namespace WebGiay.Areas.CustomerUsers.Controllers
{
    ...
    {
        public QlBanHangContext _context;
        public LoginController(QlBanHangContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Index(LoginUser model)
        {
            ...
            if (dataLogin != null)
            {
                ...
                HttpContext.Session.SetInt32("UserId", dataLogin.UserId);
